...
<main class="flex flex-col">
    ...
    <section class="bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            ...
            <h1 class="my-2 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-white">{{ $posts[0]->title }}</h1>
            <p class="mb-8 text-lg font-normal lg:text-xl sm:px-16 lg:px-48 text-gray-400">{{ $posts[0]->excerpt }}</p>
            <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                <a href="/posts/{{ $posts[0]->slug }}" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-900">
                    Read this post
